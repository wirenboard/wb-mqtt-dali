                ...
                state=ControlState(
                    meta=ControlMeta(
                        title=TranslatedTitle(
                            f"Illuminance {instance_index}", f"Освещённость {instance_index}"
                        ),
                        read_only=True,
            ...
            ControlInfo(
                ...
                state=ControlState(
                    meta=ControlMeta(
                        "pushbutton",
                        TranslatedTitle(
                            f"Short Press {instance_index}", f"Короткое нажатие {instance_index}"
                        ),
                        read_only=True,
                        order=instance_index * 10 + 3,
                    ),
            ...
            ControlInfo(
                ...
                state=ControlState(
                    meta=ControlMeta(
                        "pushbutton",
                        TranslatedTitle(
                            f"Double Press {instance_index}", f"Двойное нажатие {instance_index}"
                        ),
                        read_only=True,
